        ...
        <div className='core-bg'>
            <div className='container '>
                <div className='row my-0 my-sm-5 d-flex align-items-center'>
                    ...
                    <div className='col col-12 col-md-8 text-center text-md-start'>
                    ...
                    <div className=' col col-md-6 col-lg-3'>
                        <div style={{ border: '4px dotted #0e6a8f' }} className='core-box'>
                            <div style={{ backgroundColor: '#0e6a8f' }} className='core-con'>
                                ...
                                <div className='back fs-6'>Empowering students with knowledge and skill in robotics and AI through engagging education and hands-on-experience </div>
                            </div>
                        </div>
                    </div>
                    <div className='col col-md-6 col-lg-3'>
                        <div style={{ border: '4px dotted #bc5557' }} className='core-box  '>
                            <div style={{ backgroundColor: '#bc5557' }} className='core-con'>
                                ...
                                <div className='back fs-6'>To be a leading educational hub that inspires innovation, fosters creativity, and prepares students for successful careers in technology.
                                </div>
                            </div>
                        </div>
                    </div>
                    <div className='col col-md-6 col-lg-3'>
                        <div style={{ border: '4px dotted #08a89b' }} className='core-box  '>
                            <div style={{ backgroundColor: '#08a89b' }} className='core-con'>
                                ...
                                <div className='back fs-6'>Building a supportive and inclusive community of learners, educators, and industry professionals.</div>
                            </div>
                        </div>
                    </div>
                    <div className=' col col-md-6 col-lg-3'>
                        <div style={{ border: '4px dotted #526eb1' }} className='core-box '>
                            <div style={{ backgroundColor: '#526eb1' }} className='core-con'>
                                ...
                                <div className='back fs-6'>Foster partnerships with schools, colleges, and industry leaders to enhance learning opportunities</div>
                            </div>
                        </div>
                    </div>
