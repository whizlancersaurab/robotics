        ...
        <div className='core-bg'>
            ...
            <div className='container '>
                <div className='row my-0 my-sm-5 d-flex align-items-center '>
                    ...
                    <div data-aos='slide-left' className='col col-12 col-md-8 text-center text-md-start core-contact'>
                ...
                <div className='row  g-4 d-flex align-items-center justify-content-center mt-3 mt-sm-0'>
                    ...
                    <div data-aos='slide-right' className='col col-md-6 col-lg-3 d-flex justify-content-center'>
                    ...
                    <div data-aos='slide-up' className='col col-md-6 col-lg-3 d-flex justify-content-center'>
                    ...
                    <div data-aos='slide-down' className='col col-md-6 col-lg-3 d-flex justify-content-center'>
                    ...
                    <div data-aos='slide-left' className='col col-md-6 col-lg-3 d-flex justify-content-center'>
